...
class VersionsCest
{
    public function testAllVersionsAreRegistered(WpunitTester $I)
    {
        ...
        $I->assertEquals([
            ...
            '3.0.5' => 'PublishPress\WordpressEddLicense\initialize3Dot0Dot5',
        ], $registeredVersions);
    }
    ...
    public function testLatestVersionIsTheCurrentVersion(WpunitTester $I)
    {
        ...
        $I->assertEquals('3.0.5', $latestVersion);
    }
    ...
    public function testLatestVersionCallbackIsTheLastOne(WpunitTester $I)
    {
        ...
        $I->assertEquals('PublishPress\WordpressEddLicense\initialize3Dot0Dot5', $latestVersionCallback);
    }
    ...
    public function testInitializeLatestVersion(WpunitTester $I)
    {
        ...
        $didAction = (bool)did_action('publishpress_wordpress_edd_license_3Dot0Dot5_initialized');
